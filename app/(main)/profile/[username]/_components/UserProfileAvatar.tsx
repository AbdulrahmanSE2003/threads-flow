...
const UserProfileAvatar = ({ src }: { src: string }) => {
  ...
  return (
    <>
      <div
        className="relative group cursor-pointer w-fit rounded-full overflow-hidden hover:ring-border transition-all duration-300 shadow-sm"
      ...
      >
        <div className="flex flex-col w-full">
          {" "}
          {/* Negative margin to touch modal edges */}
          <input
            type="file"
            accept="image/*"
            className="hidden"
